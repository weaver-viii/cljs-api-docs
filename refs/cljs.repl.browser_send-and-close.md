## <img width="48px" valign="middle" src="http://i.imgur.com/Hi20huC.png"> cljs.repl.browser/send-and-close
...
└── src
    └── clj
        └── cljs
            └── repl
                └── <ins>[browser.clj:68-89](https://github.com/clojure/clojurescript/blob/r1011/src/clj/cljs/repl/browser.clj#L68-L89)</ins>
</pre>
