## <img width="48px" valign="middle" src="http://i.imgur.com/Hi20huC.png"> specialrepl/import
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[repl.cljc:608-683](https://github.com/clojure/clojurescript/blob/r3263/src/main/clojure/cljs/repl.cljc#L608-L683)</ins>
</pre>
...
{:description "import-list => (closure-namespace constructor-name-symbols*)\n\nOnly usable from a REPL.\n\nImport Google Closure classes.",
 ...
 :full-name-encode "specialrepl_import",
...
__Contributions__ to this document are accepted as Pull Requests to the following file:
 ...
 <pre>
[cljsdoc/specialrepl_import.cljsdoc](https://github.com/cljsinfo/cljs-api-docs/blob/master/cljsdoc/specialrepl_import.cljsdoc)
</pre>
