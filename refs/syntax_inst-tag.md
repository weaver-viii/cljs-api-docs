...
└── src
    └── clj
        └── cljs
            └── <ins>[tagged_literals.clj:27-30](https://github.com/clojure/clojurescript/blob/r1449/src/clj/cljs/tagged_literals.clj#L27-L30)</ins>
</pre>
...
└── src
    └── clj
        └── cljs
            └── <ins>[tagged_literals.clj:18-25](https://github.com/clojure/clojurescript/blob/r1449/src/clj/cljs/tagged_literals.clj#L18-L25)</ins>
</pre>
